...
module.exports = function () {
  return function ({ addUtilities, e, config }) {
    ...
    const onlySupportsRules = config(
    ...
    const generators = [
      ...
      (size, modifier) =>
        onlySupportsRules
          ? null
          : {
              [`.${e(`my-${modifier}-${suffix}`)}`]: {
                'margin-top': `${size}`,
                'margin-bottom': `${size}`,
              },
              [`.${e(`mx-${modifier}-${suffix}`)}`]: {
                'margin-left': `${size}`,
                'margin-right': `${size}`,
              },
            },
      (size, modifier) =>
        onlySupportsRules
          ? null
          : {
              [`.${e(`mt-${modifier}-${suffix}`)}`]: {
                'margin-top': `${size}`,
              },
              [`.${e(`mr-${modifier}-${suffix}`)}`]: {
                'margin-right': `${size}`,
              },
              [`.${e(`mb-${modifier}-${suffix}`)}`]: {
                'margin-bottom': `${size}`,
              },
              [`.${e(`ml-${modifier}-${suffix}`)}`]: {
                'margin-left': `${size}`,
              },
            },
