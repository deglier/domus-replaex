...
export default function FeatureItem(props) {
  return (
    <Container className={`py-6 px-6 lg:px-0 lg:py-0 lg:flex lg:justify-center lg:gap-x-6 ${props.reverse ? "flex-row-reverse" : ""} ${props.className}`}>
      <div className="max-w-[629px] hidden lg:block ">
